...
##
write.table(cpi,"forecasts/passado2000/csr-cpi.csv",sep=";",row.names = FALSE, col.names = FALSE)
write.table(pce,"forecasts/passado2000/csr-pce.csv",sep=";",row.names = FALSE, col.names = FALSE)
