...
##
write.table(cpi,"forecasts/presenteD/adalasso-cpi.csv",sep=";",row.names = FALSE, col.names = FALSE)
write.table(pce,"forecasts/presenteD/adalasso-pce.csv",sep=";",row.names = FALSE, col.names = FALSE)

write.table(pols.cpi,"forecasts/presenteD/pols-adalasso-cpi.csv",sep=";",row.names = FALSE, col.names = FALSE)
write.table(pols.pce,"forecasts/presenteD/pols-adalasso-pce.csv",sep=";",row.names = FALSE, col.names = FALSE)
