source("modelfunctions/functionsD/func-boosting.R")
...
write.table(cpi,"forecasts/presenteD/boosting-cpi.csv",sep=";",row.names = FALSE, col.names = FALSE)
write.table(pce,"forecasts/presenteD/boosting-pce.csv",sep=";",row.names = FALSE, col.names = FALSE)
