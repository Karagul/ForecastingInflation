source("modelfunctions/functionsD/func-scad.R")
...
##
write.table(cpi,"forecasts/presenteD/scad-cpi.csv",sep=";",row.names = FALSE, col.names = FALSE)
write.table(pce,"forecasts/presenteD/scad-pce.csv",sep=";",row.names = FALSE, col.names = FALSE)
