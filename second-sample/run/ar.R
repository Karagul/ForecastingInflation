...
##
write.table(cpi,"forecasts/presenteD/ar-cpi.csv",sep=";",row.names = FALSE, col.names = FALSE)
write.table(pce,"forecasts/presenteD/ar-pce.csv",sep=";",row.names = FALSE, col.names = FALSE)

write.table(bcpi,"forecasts/presenteD/bicar-cpi.csv",sep=";",row.names = FALSE, col.names = FALSE)
write.table(bpce,"forecasts/presenteD/bicar-pce.csv",sep=";",row.names = FALSE, col.names = FALSE)
