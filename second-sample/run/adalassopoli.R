source("modelfunctions/functionsD/func-polilasso.R")
...
##
write.table(cpi,"forecasts/presenteD/adalassopoli-cpi.csv",sep=";",row.names = FALSE, col.names = FALSE)
write.table(pce,"forecasts/presenteD/adalassopoli-pce.csv",sep=";",row.names = FALSE, col.names = FALSE)
