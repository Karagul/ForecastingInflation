...
write.table(cpi,"forecasts/passado2000/lbvar-cpi.csv",sep=";",row.names = FALSE, col.names = FALSE)
write.table(pce,"forecasts/passado2000/lbvar-pce.csv",sep=";",row.names = FALSE, col.names = FALSE)
