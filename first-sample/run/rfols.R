...
##
write.table(cpi,"forecasts/passado2000/rfols-cpi.csv",sep=";",row.names = FALSE, col.names = FALSE)
write.table(pce,"forecasts/passado2000/rfols-pce.csv",sep=";",row.names = FALSE, col.names = FALSE)
