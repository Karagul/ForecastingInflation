source("modelfunctions/functionsD/func-xgb.R")
...
##
write.table(cpi,"forecasts/presenteD/xgb-cpi.csv",sep=";",row.names = FALSE, col.names = FALSE)
write.table(pce,"forecasts/presenteD/xgb-pce.csv",sep=";",row.names = FALSE, col.names = FALSE)
