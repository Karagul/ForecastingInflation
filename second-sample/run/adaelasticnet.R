...
##
write.table(cpi,"forecasts/presenteD/adaelasticnet-cpi.csv",sep=";",row.names = FALSE, col.names = FALSE)
write.table(pce,"forecasts/presenteD/adaelasticnet-pce.csv",sep=";",row.names = FALSE, col.names = FALSE)

write.table(pols.cpi,"forecasts/presenteD/pols-adaelasticnet-cpi.csv",sep=";",row.names = FALSE, col.names = FALSE)
write.table(pols.pce,"forecasts/presenteD/pols-adaelasticnet-pce.csv",sep=";",row.names = FALSE, col.names = FALSE)
