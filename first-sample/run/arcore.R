...
bcorem=bcorem+tail(core$core[-c((length(core$core)-11):length(core$core))],132)
...
##
write.table(corem,"forecasts/passado2000/ar-core1.csv",sep=";",row.names = FALSE, col.names = FALSE)

write.table(bcorem,"forecasts/passado2000/bicar-core1.csv",sep=";",row.names = FALSE, col.names = FALSE)
