...
##
write.table(cpi,"forecasts/presenteD/lassopoli-cpi.csv",sep=";",row.names = FALSE, col.names = FALSE)
write.table(pce,"forecasts/presenteD/lassopoli-pce.csv",sep=";",row.names = FALSE, col.names = FALSE)
