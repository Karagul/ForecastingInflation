...
##
write.table(cpi,"forecasts/passado2000/jackknife-cpi.csv",sep=";",row.names = FALSE, col.names = FALSE)
write.table(pce,"forecasts/passado2000/jackknife-pce.csv",sep=";",row.names = FALSE, col.names = FALSE)
