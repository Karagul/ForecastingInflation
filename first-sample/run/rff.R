source("modelfunctions/func-rffact.R")
load("~/Dropbox/tese/inflacao jbes/workspaces/passado/randomforest.RData")
...
##
write.table(cpi,"forecasts/passado2000/rffact-cpi.csv",sep=";",row.names = FALSE, col.names = FALSE)
write.table(pce,"forecasts/passado2000/rffact-pce.csv",sep=";",row.names = FALSE, col.names = FALSE)
