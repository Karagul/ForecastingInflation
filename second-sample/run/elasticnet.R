...
##
write.table(cpi,"forecasts/presenteD/elasticnet-cpi.csv",sep=";",row.names = FALSE, col.names = FALSE)
write.table(pce,"forecasts/presenteD/elasticnet-pce.csv",sep=";",row.names = FALSE, col.names = FALSE)

write.table(pols.cpi,"forecasts/presenteD/pols-elasticnet-cpi.csv",sep=";",row.names = FALSE, col.names = FALSE)
write.table(pols.pce,"forecasts/presenteD/pols-elasticnet-pce.csv",sep=";",row.names = FALSE, col.names = FALSE)
